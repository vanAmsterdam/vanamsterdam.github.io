...
Simulation experiments are important when evaluating methods but also for applied work in for example power analyses or sensitivity analyses.
...
timings[str_detect(raw_string, "project"), machine:="macm3"]
...
timings[machine%in%c('macm1', 'macm3'), command:=word(string)]
...
# grab the time 
timings[machine%in%c('macm1', 'macm3'), time_str:=str_extract(string, "(?<=cpu\\ )(.*)(?= total)")]
