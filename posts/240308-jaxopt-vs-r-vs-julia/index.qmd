...
2. In this simple example, JAX code doesn't seem to dounting. However, JAX comes with some [sharp bits](https://jax.readthedocs.io/en/latest/notebooks/Common_Gotchas_in_JAX.html) and may be harder to program efficiently.[^1]
