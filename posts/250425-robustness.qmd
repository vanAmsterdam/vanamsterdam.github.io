...
2. how are discrminiation and calibration calculated?
...
A question that remains is *how* these differences in environments may come about.
On this, I wrote a paper titled **A causal viewpoint on prediction model performance under changes in case-mix: discrimination and calibration respond differently for prognosis and diagnosis predictions** which you can find on [ArXiv](https://arxiv.org/abs/2409.01444v3)
