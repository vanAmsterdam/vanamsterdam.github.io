...
![](figs/rt_example1.png){.fragment height=18cm}

![](figs/rt_example2.png){.fragment height=18cm}

![](figs/rt_example3.png){.fragment height=18cm}

![](figs/rt_example4.png){.fragment height=18cm}

![](figs/rt_example5.png){.fragment height=18cm}

![](figs/rt_example6.png){.fragment height=18cm}

![](figs/rt_example.png){.fragment height=18cm}
...
[The question is not "is my model accurate before / after deployment", but did deploying the model improve patient outcomes?]{.r-fit-text}
...
- models that predict outcomes under hypothetical interventions (*prediction-under-intervention models*) predict expected outcomes under the *hypothetical intervention* of giving a certain treatment
...
- when developing or evaluating AI models for medical decisions, think about
