...
## Evaluation of prediction-under-intervention 

- building prediction-under-intervention models from observational data relies on **strong assumptions** especially regarding confounding

. . .

evaluation:

- typical metrics (e.g. AUC or calibration) on *observed data* not sufficient as we want to predict well in data from *other distribution than observed data*
