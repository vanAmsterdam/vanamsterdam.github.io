...
1. formulate a model for *joint* distribution $p_{\theta}$
   - in statistics, this model family is typically 'small'
   - in machine learning, this model family is typically 'large'
...
![](stats-vs-ai/Slide2.png){width="100%" fig-align="center" .fragment .fade-in-then-out}

![](stats-vs-ai/Slide3.png){width="100%" fig-align="center" .fragment .fade-in}
...
- use optimizer to minimize loss function (e.g. Adam)
- regularization:
...
## Where would CCNs be useful for images?
...
- post-processed to optimize user experience (remove offensive language, etc.)
  - present test-user with two options, ask which is better
...
![](figs/library_bing.jpeg){width=20%}

![](figs/brain_bing.jpeg){width=20%}
