...
![bit.ly/ai-menti](mentimeter_qr_code.png){width="80%" fig-align="center"}
...
[What tasks can we perform with machine learning?]{.r-stretch}
...
- what data was it trained on, what architecture?
- is this a 'stochastic parrot'?
- arguably, it could learn almost anything
