...
I first distinghuish models that predict in the causal direction (e.g. predicting a heart attack based on cholesterol and age) from those that predict in the anti-causal direction (e.g. predicting a CVA based on neurological symptoms).
