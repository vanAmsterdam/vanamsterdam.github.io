...
- want AI to imrpove healthcare
- getting far with predicting / modeling statistical associations
- takes a jump to get to better decision making
- models developed with causality in mind can navigate some of these jumps
